...
class TransformerControlnet(nn.Module):
    ...
    def __init__(
        ...
        self.controlnet_mode_embedder = nn.Embedding(3072, 10)
    ...
    def forward(
        ...
        encoder_hidden_states = mx.concatenate([controlnet_mode_emb, encoder_hidden_states], axis=1)
        txt_ids = mx.concatenate([txt_ids[:, :1], txt_ids], axis=1)
